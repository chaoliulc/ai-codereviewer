...
import { PRDetails } from "./interface";

export class LLMService {

    constructor(private llmClient: OpenAI, private llmModel: string) { }

    private createPrompt(file: File, chunk: Chunk, prDetails: PRDetails): string {
...
`;
    ...
    async getAIResponse(prompt: string): Promise<Array<{
        lineNumber: string;
